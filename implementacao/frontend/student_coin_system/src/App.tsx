...
function App() {
  const [currentPage, setCurrentPage] = useState<'login' | 'gerenciamentoProfessor' | 'gerenciamentoAluno' | 'gerenciamentoEmpresa' | 'visualizacaoAluno' | 'visualizacaoEmpresa'>('login');
